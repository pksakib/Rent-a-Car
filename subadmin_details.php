...
<?php
	if(isset($_POST["Register"])){
		...
		if(!empty($Email) && !empty($Pass) && !empty($Pass2) && !empty($Nid) && !empty($Mobile)){
			...
			$query= "INSERT INTO `subadmin`(`username`,`email`, `password`, `nid`, `phone`) VALUES ('$username','$Email', '$Pass', '$Nid','$Mobile')";
...
<body>
	...
	<div class="navbar navbar-expand-lg navbar-light">
		<form class="form" method="post" action="subadmin_details.php">
			<div class="form-row">
